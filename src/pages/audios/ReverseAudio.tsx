...
export default function ReverseAudio() {
    ...
    const currentTaskId = getTaskIdByName("Reversing Audio");
   ...
   const handleProcessing = async () => {
      ...
      addTask(newTaskId, "Reversing Audio", '/audio/reverse');
      ...
      try {
        ...
        const result = await window.electronAPI.reverseAudio({
    ...
    const handleCancel = async () => {
        const taskId = getTaskIdByName("Reversing Audio");
        if (!taskId) return;
        ...
        {/* Header Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 dark:border-gray-700 rounded-lg shadow-md p-6 border border-gray-200">
                <h2 className="text-xl dark:text-white font-semibold mb-4 text-gray-700">Reverse Audio</h2>
                {/* Process Button */}
                <AudioSubmitBtn
                    progressTitle={"Reversing audio..."}
                    btnTitle={"Reverse Audio & Save"}
