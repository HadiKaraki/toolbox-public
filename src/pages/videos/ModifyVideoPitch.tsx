...
export default function ModifyVideoPitch() {
    ...
    const currentTaskId = getTaskIdByName("Modifying Video Pitch");
   ...
   const handleProcessing = async () => {
      ...
      addTask(newTaskId, "Modifying Video Pitch", '/video/pitch');
    ...
    const handleCancel = async () => {
        const taskId = getTaskIdByName("Modifying Video Pitch");
        if (!taskId) return;
