...
export default function StabilizeVideo() {
    ...
    const currentTaskId = getTaskIdByName("Stabilizing Video");
   ...
   const handleProcessing = async () => {
      ...
      addTask(newTaskId, "Stabilizing Video", '/video/stabilize');
    ...
    const handleCancel = async () => {
        const taskId = getTaskIdByName("Stabilizing Video");
        if (!taskId) return;
